...
const mockProjects = [
  {
    ...
    schemeLinked: 'Self Employment Scheme',
    workStatus: 'Ongoing' as const,
    assetsDeployed: 'Cleaning Equipment, Vacuum Machines, Safety Gear',
    manpowerUtilized: 8,
    paymentReceived: 150000,
    salaryPaid: 80000,
    remarks: 'Project is progressing well. Equipment procurement completed and training for workers in progress.',
  },
  {
    id: '2',
    ...
    schemeLinked: 'Skill Development Training',
    workStatus: 'Completed' as const,
    assetsDeployed: 'Training Materials, Safety Equipment',
    manpowerUtilized: 12,
    paymentReceived: 50000,
    salaryPaid: 40000,
    remarks: 'Successfully completed. All members received certification and 10 members got employment.',
  },
  {
    id: '3',
    ...
    schemeLinked: 'Housing Assistance',
    workStatus: 'Ongoing' as const,
    assetsDeployed: 'Construction Materials, Plumbing Equipment',
    manpowerUtilized: 15,
    paymentReceived: 0,
    salaryPaid: 0,
    remarks: 'Awaiting final approval from authorities. Site preparation completed.',
  },
];
...
const mockLoans = [
  {
    ...
    assetsDeployed: 'Sanitation Equipment, Vehicles, Safety Gear',
    manpowerUtilized: 8,
    salaryPaid: 80000,
    bankLinked: true,
    repaymentSchedule: [
      { date: '2025-12-15', amount: 5000, status: 'pending' as const },
      { date: '2026-01-15', amount: 5000, status: 'pending' as const },
      { date: '2026-02-15', amount: 5000, status: 'pending' as const },
    ],
  },
  {
    id: 'L002',
    ...
    assetsDeployed: 'Training Materials, Tools',
    manpowerUtilized: 5,
    salaryPaid: 30000,
    bankLinked: true,
    repaymentSchedule: [
      { date: '2025-12-20', amount: 2500, status: 'pending' as const },
      { date: '2026-01-20', amount: 2500, status: 'pending' as const },
    ],
  },
];
